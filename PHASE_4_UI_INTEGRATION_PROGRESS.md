...
Phase 4 integrates the NMEA data pipeline (Parser → Service → Provider) with user-facing screens. Real-time navigation
data now flows from NMEA 0183 sources to the UI, replacing placeholder values with live marine data.
