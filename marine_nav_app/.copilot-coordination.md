...
### Role:
- Quality gate: continuous `flutter analyze`, `flutter test`, lint compliance
- Conflict prevention: monitoring file ownership across all instances
- Development: unassigned work (forecast, CI/CD, docs, refactoring)
- Enforces 300-line file limit and architecture rules

### Files Owned (do NOT edit without coordinating):
_(To be populated by Marsal as work begins)_
