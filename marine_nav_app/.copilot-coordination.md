...
### Currently Editing: `lib/widgets/map/map_webview.dart` (removing Map Preview overlay)
...
- `lib/models/boat_position.dart` (NEW)
- `lib/providers/map_provider.dart`
- `lib/providers/boat_provider.dart` (NEW)
- `lib/services/location_service.dart` (NEW)
- `test/providers/map_provider_test.dart`
- `test/providers/boat_provider_test.dart` (NEW)

### Currently Editing: Creating FEAT-002 files (BoatPosition model, BoatProvider)
