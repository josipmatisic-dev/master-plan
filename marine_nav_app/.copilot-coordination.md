...
### Currently Editing: Phase 7 — Interactive particles, profile persistence, holographic effects
- `lib/widgets/effects/particle_background.dart`
- `lib/screens/profile_screen.dart`
- `lib/providers/settings_provider.dart`
- `lib/widgets/effects/holographic_shimmer.dart` (NEW)
- `lib/widgets/effects/scan_line_effect.dart` (NEW)
...
### Currently Editing: FEAT-005 Route Visualization
- Adding route line + waypoint markers to map.html
- Creating map_route_bridge.dart for route JS methods
- Wiring RouteProvider → map rendering in map_webview.dart
