...
### ⚠️ Note from Mirko (2026-02-14) — I edited your NMEA files for FEAT-007:
...
- Tests added to `nmea_parser_test.dart` (HDG/MTW parsing + NMEAData heading getters). Please review.
